        ...
        <div class="right_col" role="main">
		   ...
		   <div class="row">
            <div class="col-md-12 col-sm-4 col-xs-12">
              <div class="x_panel">
				<marquee behavior="scroll" direction="left" scrollamount="3"><?php foreach($setting as $marquee){echo $marquee['VALUES'];};?></marquee>
              </div>
            </div>
          </div>
		  <!-- end marquee-->
              ...
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
				  ...
				  <div class="dashboard-widget-content">
						Welcome <?=$this->session->userdata('fullname');?> To Simple Accounting System</br>
